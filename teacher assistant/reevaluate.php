...
$x= $_SESSION['username'];
$file=$_SESSION['file'];
$sql="SELECT `sub_id` FROM `ta_upload` WHERE `file`='$file' "; 
	...
	<div class="row">
		...
		<div class="col-md-6">
            <div class="form-group">
                 <form name="add_mc" id="add_mc" action="reevaluate.php" method="POST">
	...
	$number = count($_POST['marks']);    
      ...
      {  
           ...
           {  
                ...
                $sql = "INSERT INTO `ta_reevaluate`(`username`, `sub_id`, `file`, `max_marks`, `marks`, `remarks`) VALUES ('$x','$sub_id','$file', '$max_marks', '$marks','$remarks')"; 
                $run=mysqli_query($con, $sql);  
           }  
      } ?>
    <script>
